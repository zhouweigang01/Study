...
{
    public partial class ValidateUserBPProxy : NHExt.Runtime.Model.BizAgent
    {
		private string _guid ="3468e3f5-2977-495b-8a26-03a705ffc6e1";
		public override string Guid {
			get{
				return _guid;
			}
		}
		private string _proxyName = "THU.LabSystemBP.Agent.ValidateUserBPProxy";
