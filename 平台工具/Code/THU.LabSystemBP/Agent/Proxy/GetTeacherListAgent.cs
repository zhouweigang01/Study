...
{
    public partial class GetTeacherListProxy : NHExt.Runtime.Model.BizAgent
    {
		...
		private string _proxyName = "THU.LabSystemBP.Agent.GetTeacherListProxy";
