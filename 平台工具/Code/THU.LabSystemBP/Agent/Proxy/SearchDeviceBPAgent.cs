...
{
    public partial class SearchDeviceBPProxy : NHExt.Runtime.Model.BizAgent
    {
		...
		private string _proxyName = "THU.LabSystemBP.Agent.SearchDeviceBPProxy";
