...
{
    public partial class DeleteForbitBPProxy : NHExt.Runtime.Model.BizAgent
    {
		private string _guid ="a4ea19f3-60e9-4f3c-a6f7-68ff3ce0e193";
		public override string Guid {
			get{
				return _guid;
			}
		}
		private string _proxyName = "THU.LabSystemBP.Agent.DeleteForbitBPProxy";
