...
{
    public partial class ModifyRepairAlarmBPProxy : NHExt.Runtime.Model.BizAgent
    {
		private string _guid ="5f31c0e9-e1dd-4525-b597-e0a4c78e5f62";
		public override string Guid {
			get{
				return _guid;
			}
		}
		private string _proxyName = "THU.LabSystemBP.Agent.ModifyRepairAlarmBPProxy";
