...
{
    public partial class DeleteEnumBPProxy : NHExt.Runtime.Model.BizAgent
    {
		private string _guid ="72f2b0ed-707c-47f2-b884-755beb908096";
		public override string Guid {
			get{
				return _guid;
			}
		}
		private string _proxyName = "THU.LabSystemBP.Agent.DeleteEnumBPProxy";
