...
{
    public partial class GetAdminUserBPProxy : NHExt.Runtime.Model.BizAgent
    {
		...
		private string _proxyName = "THU.LabSystemBP.Agent.GetAdminUserBPProxy";
