...
{
    public partial class UseCompleteBPProxy : NHExt.Runtime.Model.BizAgent
    {
		...
		private string _proxyName = "THU.LabSystemBP.Agent.UseCompleteBPProxy";
