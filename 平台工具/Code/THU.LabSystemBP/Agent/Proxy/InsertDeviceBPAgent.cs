...
{
    public partial class InsertDeviceBPProxy : NHExt.Runtime.Model.BizAgent
    {
		private string _guid ="2afef3c2-9980-4959-be05-9de749403294";
		public override string Guid {
			get{
				return _guid;
			}
		}
		private string _proxyName = "THU.LabSystemBP.Agent.InsertDeviceBPProxy";
