...
{
    public partial class DeleteAdminUserBPProxy : NHExt.Runtime.Model.BizAgent
    {
		private string _guid ="65214605-68bc-4280-96f7-c8e679345c69";
		public override string Guid {
			get{
				return _guid;
			}
		}
		private string _proxyName = "THU.LabSystemBP.Agent.DeleteAdminUserBPProxy";
