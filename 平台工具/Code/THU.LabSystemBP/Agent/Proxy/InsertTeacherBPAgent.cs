...
{
    public partial class InsertTeacherBPProxy : NHExt.Runtime.Model.BizAgent
    {
		...
		private string _proxyName = "THU.LabSystemBP.Agent.InsertTeacherBPProxy";
