...
{
    public partial class InsertEnumBP : NHExt.Runtime.Model.BizProxy
    {
		...
		private string _proxyName = "THU.LabSystemBP.InsertEnumBP";
...
internal THU.LabSystemBE.Deploy.CommonEnumDTO Do()
{
...
private THU.LabSystemBE.Deploy.CommonEnumDTO DoCommon(NHExt.Runtime.Proxy.ProxyContext ctx)
{
