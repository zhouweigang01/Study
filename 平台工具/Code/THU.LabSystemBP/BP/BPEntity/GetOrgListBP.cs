...
{
    public partial class GetOrgListBP : NHExt.Runtime.Model.BizProxy
    {
		...
		private string _proxyName = "THU.LabSystemBP.GetOrgListBP";
...
private List<> DoCommon(NHExt.Runtime.Proxy.ProxyContext ctx)
{
...
private List<> TypeConvert(List<> obj)
{
