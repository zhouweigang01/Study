...
{
    public partial class SearchDeviceListBP : NHExt.Runtime.Model.BizProxy
    {
		...
		private string _proxyName = "THU.LabSystemBP.SearchDeviceListBP";
...
internal List<THU.LabSystemBE.Deploy.DeviceDTO> Do()
{
...
private List<THU.LabSystemBE.Deploy.DeviceDTO> DoCommon(NHExt.Runtime.Proxy.ProxyContext ctx)
{
...
private List<THU.LabSystemBE.Deploy.DeviceDTO> TypeConvert(List<THU.LabSystemBE.Deploy.DeviceDTO> obj)
{
