...
{
    public partial class SearchTeacherListBP : NHExt.Runtime.Model.BizProxy
    {
		...
		private string _proxyName = "THU.LabSystemBP.SearchTeacherListBP";
...
internal List<THU.LabSystemBE.Deploy.TeacherDTO> Do()
{
...
private List<THU.LabSystemBE.Deploy.TeacherDTO> DoCommon(NHExt.Runtime.Proxy.ProxyContext ctx)
{
...
private List<THU.LabSystemBE.Deploy.TeacherDTO> TypeConvert(List<THU.LabSystemBE.Deploy.TeacherDTO> obj)
{
